...
namespace MusicShop
{
    public partial class FormMusicCollection : Form
    {
        ...
        private void FormMusicCollection_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            textBoxGenre.Text= dataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
            textBoxArtist.Text = dataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString();
            textBoxAlbum.Text = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                try
                {
                    ...
                    string Query = "insert into music.mucollection(Genre,Artist,Album,Price) values('" + this.textBoxGenre.Text + "','" + this.textBoxArtist.Text + "','" + this.textBoxAlbum.Text + "','" + this.textBoxPrice.Text + "');";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connectionString = @"Data Source=" + server + ";Initial Catalog=" + database + ";User ID=" + UserName + ";" + "Password=" + Password;
                string Query = "delete from music.mucollection where id=" + IDToDelete;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string Query = "UPDATE music.mucollection SET Genre = '" + this.textBoxGenre.Text + "',  Artist = '" + this.textBoxArtist.Text + "',  Album = '" + this.textBoxAlbum.Text + "',  Price = '" + this.textBoxPrice.Text + "' WHERE id = '" + this.textBoxid.Text + "'; ";
