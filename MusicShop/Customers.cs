    ...
    public partial class Customers : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                try
                {
                    ...
                    string Query = "insert into music.customers(Firstname,Lastname,Email,Mobile) values('" + this.textBoxFirstName.Text + "','" + this.textBoxLastName.Text + "','" + this.textBoxEmail.Text + "','" + this.textBoxMobile.Text + "');";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connectionString = @"Data Source=" + server + ";Initial Catalog=" + database + ";User ID=" + UserName + ";" + "Password=" + Password;
                string Query = "delete from music.customers where id=" + IDToDelete;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string Query = "UPDATE music.customers SET Firstname = '" + this.textBoxFirstName.Text + "',  Lastname = '" + this.textBoxLastName.Text + "',  Email = '" + this.textBoxEmail.Text + "',  Mobile = '" + this.textBoxMobile.Text + "' WHERE Id = '" + this.textBoxid.Text + "'; ";
